#ifndef _AI3D_GUI_IMPORTPOS_H
#define _AI3D_GUI_IMPORTPOS_H


#include <QDialog>
#include<QStandardItemModel>
#include "ui_ImportPosWgt.h"
...
namespace AI3D
{
	namespace GUI
	{
		class ImportPosDia : public QDialog
		{
			Q_OBJECT

		public:
			ImportPosDia(QDialog* parent = Q_NULLPTR);
			~ImportPosDia();
			...
			static QVector<QStringList> readPosFile(QString fileName);
