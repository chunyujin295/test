 ...
 *
 * When using FilterLineEdit the value(), setValue() and clearValue() methods should be used
    ...
    namespace PROJ
    {
        ...
        public:
            ...
            Q_ENUM(ClearMode)
                ...
                /**
                 * Constructor for FilterLineEdit.
                 * \param parent parent widget
                 * \param nullValue string for representing null values
                 */
                FilterLineEdit(QWidget* parent = nullptr, const QString& nullValue = QString());
        ...
        /**
         * Private FilterLineEdit subclass for use as a line edit in QgsSpinBox/QgsDoubleSpinBox
         * we let FilterLineEdit handle display of the clear button and detection
         * of clicks, but override clearValue() and let Qgs(Double)SpinBox handle the clearing
         * themselves.
         */
        class  SpinBoxLineEdit : public FilterLineEdit
        {
            Q_OBJECT
