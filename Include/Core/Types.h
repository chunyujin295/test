...
namespace BusinessType
{
    ...
    const std::string SC_EXPORT = "sc_export";
    const std::string FORMAT_CONVERT = "format_convert";
    const std::string DSM_DOM = "dsm_dom";
    const std::string DENSE_POINTCLOUD = "dense_pointcloud";
    const std::string MESH = "mesh"; // MESH (OBJ / OSGB)
    const std::string DGS_SELF = "3dgs_self";
    const std::string DGS_GAODE = "3dgs_gaode";
    const std::string DGS_THIRD = "3dgs_third";
