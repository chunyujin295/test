 ...
 * \since QGIS 2.7
 */
class  QgsProjectionSelectionWidget : public QWidget
{
    Q_OBJECT
  public:
    ...
    bool optionVisible(const QgsCoordinateReferenceSystem& crs) const;
    void setOptionVisible(const QgsCoordinateReferenceSystem option, const bool visible);
    /**
  ...
  /*  ComboxTreeModel* m_pTreeModel;
    QTreeComboBoxView* m_pTreeView;*/
    TreeViewDataInfoList datalist;
    QTreeListComboBox* m_pCombox = nullptr;
    /*QComboBoxQgsHighlightableComboBox* m_pCombox = nullptr;*/
