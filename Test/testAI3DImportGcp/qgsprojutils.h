...
#endif
#endif
static QString qgisUserDatabaseFilePath() { return "E:/Code/Mok/master/data/proj/usersrs.db"; }

static QString srsDatabaseFilePath(){ return "E:/Code/Mok/master/data/proj/srs.db"; }
/**
 * \class QgsProjUtils
 * \ingroup core
