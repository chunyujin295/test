...
class  QgsCoordinateReferenceSystem
{
  ...
  public:
     ...
     */
    Q_DECL_DEPRECATED explicit QgsCoordinateReferenceSystem( long id, CrsType type = PostgisCrsId) ;
    ...
    */
    ...
    static QgsCoordinateReferenceSystem fromENUDefinition(const QString& definition);
    /**
    ...
    */
    ...
    Q_INVOKABLE static  QgsCoordinateReferenceSystem fromSpecialEpsg(const QString& definition);
    /**
    ...
    */
    Q_DECL_DEPRECATED static QgsCoordinateReferenceSystem fromProj4( const QString &proj4 ) ;
    ...
    */
     ...
     */
    Q_DECL_DEPRECATED bool createFromId( long id, CrsType type  ) ;
     ...
     */
    Q_DECL_DEPRECATED static void setupESRIWktFix() ;
     ...
     */
    Q_DECL_DEPRECATED static QStringList recentProjections() ;
