...
namespace AI3D
{
    namespace PROJ
    {
        FilterLineEdit::FilterLineEdit(QWidget* parent, const QString& nullValue)
            : QLineEdit(parent)
            , mNullValue(nullValue)
        {
           ...
           /* mClearIcon.addPixmap( QgsApplication::getThemeIcon( "/mIconClearText.svg" ).pixmap( QSize( iconSize, iconSize ) ), QIcon::Normal, QIcon::On );
            ...
            connect(this, &QLineEdit::textChanged, this,
                &FilterLineEdit::onTextChanged);
        }

        void FilterLineEdit::setShowClearButton(bool visible)
        {
            mClearButtonVisible = visible;
            updateClearIcon();
        }

        void FilterLineEdit::setShowSearchIcon(bool visible)
        {
        ...
        void FilterLineEdit::updateClearIcon()
        {
            ...
            if (showClear && !mClearAction)
            {
                ...
                connect(mClearAction, &QAction::triggered, this, &FilterLineEdit::clearValue);
            }
        ...
        void FilterLineEdit::clearValue()
        {
            switch (mClearMode)
            {
            case ClearToNull:
        ...
        void FilterLineEdit::onTextChanged(const QString& text)
        {
            updateClearIcon();
        ...
        void FilterLineEdit::updateBusySpinner()
        {
        ...
        bool FilterLineEdit::selectOnFocus() const
        {
            return mSelectOnFocus;
        }

        void FilterLineEdit::setSelectOnFocus(bool selectOnFocus)
        {
        ...
        bool FilterLineEdit::showSpinner() const
        {
            return mShowSpinner;
        }

        void FilterLineEdit::setShowSpinner(bool showSpinner)
        {
            ...
            if (showSpinner)
            {
                ...
                //mBusySpinnerAnimatedIcon->connectFrameChanged( this, &FilterLineEdit::updateBusySpinner );
            }
            else
            {
                //mBusySpinnerAnimatedIcon->disconnectFrameChanged( this, &FilterLineEdit::updateBusySpinner );
        ...
        bool FilterLineEdit::shouldShowClear() const
        {
        ...
        bool FilterLineEdit::event(QEvent* event)
        {
        ...
        void FilterLineEdit::storeState()
        {
        ...
        void FilterLineEdit::restoreState()
        {
        ...
        /// @cond PRIVATE
        void SpinBoxLineEdit::focusInEvent(QFocusEvent* e)
        {
            FilterLineEdit::focusInEvent(e);
            if (isNull())
            {
                clear();
            }
