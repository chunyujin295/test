...
namespace AI3D
{
    namespace PROJ
    {
        QString VariantUtils::typeToDisplayString(QVariant::Type type, QVariant::Type subType)
        {
            switch (type)
            {
        ...
        QMetaType::Type VariantUtils::variantTypeToMetaType(QVariant::Type variantType)
        {
            
            return static_cast<QMetaType::Type>(variantType);
        }

        QVariant::Type VariantUtils::metaTypeToVariantType(QMetaType::Type metaType)
        {
